...
public class SnowyIcyCreatureAbilityProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity sourceentity) {
		if (sourceentity == null)
			return;
		if (sourceentity instanceof SnowyIcyCreatureEntity) {
			ReworldMod.queueServerWork(15, () -> {
				{
					...
					if (!projectileLevel.isClientSide()) {
						...
						}.getArrow(projectileLevel, sourceentity, 6, 2);
