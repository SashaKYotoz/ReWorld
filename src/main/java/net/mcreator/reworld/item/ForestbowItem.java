...
import net.mcreator.reworld.procedures.ForestbowRangedItemUsedProcedure;

import java.util.function.Predicate;

public class ForestbowItem extends ProjectileWeaponItem implements Vanishable {
	public static final int MAX_DRAW_DURATION = 20;
	public static final int DEFAULT_RANGE = 20;

	public ForestbowItem() {
		super(new Item.Properties().durability(764));
	}
	...
	public void releaseUsing(ItemStack p_40667_, Level p_40668_, LivingEntity p_40669_, int p_40670_) {
		if (p_40669_ instanceof Player player) {
			...
			ForestbowRangedItemUsedProcedure forestbowRangedItemUsedProcedure = new ForestbowRangedItemUsedProcedure(i);
			...
			if (!itemstack.isEmpty() || flag) {
				...
				if (!((double) f < 0.1D)) {
					...
					ForestbowRangedItemUsedProcedure.execute(p_40669_, itemstack);
				}
			}
		}
	}
