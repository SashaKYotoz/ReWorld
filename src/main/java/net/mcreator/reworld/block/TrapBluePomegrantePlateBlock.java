...
import net.mcreator.reworld.procedures.TrapBluePomegrantePlateEntityCollidesInTheBlockProcedure;

import java.util.List;
import java.util.Collections;

public class TrapBluePomegrantePlateBlock extends PressurePlateBlock {
	public TrapBluePomegrantePlateBlock() {
	...
	public void attack(BlockState blockstate, Level world, BlockPos pos, Player entity) {
		...
		TrapBluePomegrantePlateEntityCollidesInTheBlockProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity);
	}
