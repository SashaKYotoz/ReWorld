...
import net.mcreator.reworld.procedures.MelothriaPlantRightClickedProcedure;
import net.mcreator.reworld.procedures.MelothriaPlantDestroyedByPlayerProcedure;
import net.mcreator.reworld.init.ReworldModItems;

public class MelothriaBlock extends CropBlock {
	public static final int MAX_AGE = 7;
	public static final IntegerProperty AGE = BlockStateProperties.AGE_7;

	public MelothriaBlock() {
	...
	protected ItemLike getBaseSeedId() {
		return ReworldModItems.MELOTHRIA.get();
	}
	...
	public boolean onDestroyedByPlayer(BlockState blockstate, Level world, BlockPos pos, Player entity, boolean willHarvest, FluidState fluid) {
		...
		MelothriaPlantDestroyedByPlayerProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate);
		return retval;
	}
