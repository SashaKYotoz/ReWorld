...
import net.mcreator.reworld.procedures.ChufaPlantDestroyedByPlayerProcedure;
import net.mcreator.reworld.init.ReworldModItems;

public class ChufaBlock extends CropBlock {
	...
	protected ItemLike getBaseSeedId() {
		return ReworldModItems.CHUFA.get();
	}

	@Override
	public boolean onDestroyedByPlayer(BlockState blockstate, Level world, BlockPos pos, Player entity, boolean willHarvest, FluidState fluid) {
		boolean retval = super.onDestroyedByPlayer(blockstate, world, pos, entity, willHarvest, fluid);
		ChufaPlantDestroyedByPlayerProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate);
		return retval;
	}
